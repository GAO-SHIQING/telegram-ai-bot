...
在群聊中使用 `/summary` 命令，机器人会智能分析群聊消息，生成总结报告：
...
🤖 AI 总结：
🔥 项目进度、技术方案、测试计划
💬 前端开发进度良好，后端API接口基本完成
📌 本周五进行联调，下周一开始测试
```

详细使用说明请查看 [群消息总结功能指南](GROUP_SUMMARY.md)。
...
├── README.md             # 项目说明
├── GROUP_SUMMARY.md      # 群消息总结指南
├── CHANGELOG.md          # 更新日志
├── LICENSE               # 开源协议
├── chat_history/         # 对话历史（自动生成）
└── group_messages/       # 群消息记录（自动生成）
```
